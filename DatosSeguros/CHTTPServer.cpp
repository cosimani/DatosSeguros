    ...
    , m_bUseFloodProtection(true)
{
    ...
    if (port > 0)
    {
        ...
        {
            qWarning() << QString("CHTTPServer::CHTTPServer() : escuchando en puerto %1").arg(port);
...
{
    qDebug() << "void CHTTPServer::onNewConnection() /////// Nueva conexion entrante al CHTTPServer";
